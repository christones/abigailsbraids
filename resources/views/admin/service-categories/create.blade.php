...
@section('title', "Nouvelle catégorie — Espace salon")
    ...
    <section class="mx-auto max-w-3xl px-4 py-12 sm:px-6 lg:px-8">
        <div class="flex flex-wrap items-center justify-between gap-4">
            <div>
                ...
                <h1 class="section-title mt-1 text-2xl sm:text-3xl">Nouvelle catégorie</h1>
            </div>
            <a href="{{ route('admin.service-categories.index') }}" class="btn-secondary text-sm">Retour</a>
        </div>

        <form method="POST" action="{{ route('admin.service-categories.store') }}" class="card mt-8 space-y-6 p-8">
            @csrf
